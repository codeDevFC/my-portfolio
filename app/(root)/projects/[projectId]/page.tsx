...
const githubUsername = "codeDevFC";
  ...
  return (
    <article className="container relative max-w-3xl py-6 lg:py-10">
      ...
      <div>
        ...
        {project.category && <ChipContainer textArr={project.category} />}
        <div className="mt-4 flex space-x-4">
          <Link href={siteConfig.links.github} className="flex items-center space-x-2 text-sm">
            ...
            <div className="flex-1 text-left leading-tight">
              <p className="font-medium">Felix Cobbinah</p>
              <p className="text-[12px] text-muted-foreground">
                @{siteConfig.username || githubUsername}
              </p>
            </div>
          </Link>
        </div>
      ...
      {project.pagesInfoArr && project.pagesInfoArr.length > 0 && (
        <div className="mb-7">
          ...
          {project.pagesInfoArr.map((page: { title: string; description: string; imgArr?: string[] }, ind: number) => (
            <div key={ind}>
              ...
              <div>
                ...
                {page.imgArr && page.imgArr.map((img: string, imgInd: number) => (
                  <Image
                    src={img}
                    key={imgInd}
                    alt={img}
